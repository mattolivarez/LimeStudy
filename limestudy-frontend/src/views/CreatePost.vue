<template>
    <div class="create-post">
        ...
        <div class="container">
            ...
            <div class="editor">
                <vue-editor :editorOptions="editorSettings" v-model="blogHTML" useCustomImageHandler @image-added="imageHandler" /> <!-- @image-added="imageHandler" -->
            </div>
    ...
    methods: {
        ...
        uploadBlog() {
            if (this.blogTitle.length !== 0 && this.blogHTML.length !== 0)
            {
                ...
                this.error = true;
                this.errorMessage = "Please ensure Blog Cover Photo was uploaded!";
                setTimeout(() => {
                    this.error = false;
                }, 5000);
                return;
            ...
            this.error = true;
            this.errorMessage = "Please ensure Blog Title and Blog Post has been filled!";
            setTimeout(() => {
                this.error = false;
            }, 5000);
            return;
