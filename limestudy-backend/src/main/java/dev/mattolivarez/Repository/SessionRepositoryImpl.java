...
public class SessionRepositoryImpl implements SessionRepository
{
    ...
    private static final String SQL_FIND_ALL = "SELECT SESSION_ID, FLASHCARD_ID, DECK_ID, CLASS_ID, USER_ID, SESSION_CORRECT, SESSION_INCORRECT, TO_CHAR(SESSION_DATE, 'MM/DD/YYYY') AS SESSION_DATE " +
            "FROM \"SESSION\" " +
    ...
    private static final String SQL_FIND_IF_EXISTS = "SELECT SESSION_ID, FLASHCARD_ID, DECK_ID, CLASS_ID, USER_ID, TO_CHAR(SESSION_DATE, 'MM/DD/YYYY') AS SESSION_DATE, SESSION_CORRECT, SESSION_INCORRECT " +
            "FROM \"SESSION\" " +
